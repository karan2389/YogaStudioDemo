...
export const adminResourceConfigs: Record<AdminResource, AdminResourceConfig> = {
  ...
  classes: {
    ...
    copy: "Control the class catalogue, instructor assignment, capacity and public pricing.",
    fields: [
      { key: "name", label: "Class name", type: "text", required: true }, { key: "slug", label: "URL slug", type: "text", required: true },
    ...
    newRecord: () => ({ id: id("class"), name: "", slug: "", categoryId: "cat-foundation", instructorId: "ins-nikita", description: "", difficulty: "All levels", durationMinutes: 60, price: 600, capacity: 12, image: "/class.jpg", accent: "#58745d" }),
  },
  categories: {
